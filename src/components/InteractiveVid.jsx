...
const InteractiveVid = () => {
  return (
    <motion.section
      className="w-full flex flex-col md:flex-row items-center justify-between px-6 md:px-16 pt-8 bg-white md:mt-0" // Added padding and margin for responsiveness
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
