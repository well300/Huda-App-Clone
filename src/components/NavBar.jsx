...
const Navbar = () => {
  ...
  const dropdownVariants = { hidden: { opacity: 0, y: -40 }, visible: { opacity: 10, y: 0 } };
  ...
  return (
    <motion.nav
  className={`fixed w-full z-10 transition-all duration-300 ${scrolled ? "bg-gradient-to-r from-[#087D72] to-[#0C5C59] shadow-lg" : "bg-gradient-to-r from-[#087D72] to-[#0C5C59]"}`}
  initial={{ y: -80 }}
  animate={{ y: 0 }}
>
  <div className="w-full px-4 sm:px-8 md:px-24">
